// Adapted from nf-core/rnaseq source code for lib/NfcoreTemplate.groovy. 
...
class Logging {
    ...
    public static String logo(workflow) {
         ...
         String.format(
            """\n
        ${dashedLine()}
        ${colors.blue}   _____           _      ____   _                         _       _______       _____${colors.reset}
        ${colors.blue}  / ____|         | |    |  _ \\ (_)                       (_)   /\\|__   __|/\\   /____|${colors.reset}
        ${colors.blue} | (___   ___ __ _| | ___| |_) | _  ___ ______ _   _ _ __  _   /  \\  | |  /  \\ | |     ${colors.reset}
        ${colors.blue}  \\___ \\ / __/ _` | |/ _ \\  _  <| |/ _  \\_____| | | | '_ \\| | / /\\ \\ | | / /\\ \\| |     ${colors.reset}
        ${colors.blue}  ____) | (_| (_| | |  __/ |_)  | | (_) |     | |_| | | | | |/ ____ \\| |/ ____ \\ |____ ${colors.reset}
        ${colors.blue} |_____/ \\___\\__,_|_|\\___|_____/|_|\\___/       \\__,_|_| |_|_/_/    \\_\\_/_/    \\_\\_____|${colors.reset}
